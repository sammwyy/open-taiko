var languageList = ["ja", "en", "es", "cn", "tw", "ko"];
var translations = {
  name: {
    ja: "日本語",
    en: "English",
  ...
  titleDisclaimer: {
    ...
    es: "Este es un proyecto que no está ligado a BANDAI NAMCO de ninguna forma.",
  ...
  sessionStart: {
    ...
    es: "Comenzar juego multijugador",
    cn: "开始在线会话！",
    tw: "開始多人模式!",
    ko: "온라인 세션 시작!",
  },
  sessionEnd: {
    ...
    es: "Finalizar juego multijugador",
    cn: "结束在线会话",
    tw: "結束多人模式",
    ko: "온라인 세션 끝내기",
  },
  ...
  pauseOptions: {
    ...
    es: ["Continuar", "Reintentar", "Volver al menu"],
  ...
  errorOccured: {
    ...
    es: "Ha ocurrido un error, reinicia la página",
  },
  tutorial: {
    basics: {
      ja: [
